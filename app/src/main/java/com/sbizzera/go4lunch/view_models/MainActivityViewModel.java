...
public class MainActivityViewModel extends ViewModel {
    ...
    MainActivityViewModel(FireStoreService fireStore, PermissionService permissionService, LocationService locationService, SharedPreferencesRepo sharedPreferencesRepo) {
